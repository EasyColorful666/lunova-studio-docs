...
或者，您也可以手动在 Visual Studio 中的 `程序包管理器控制台` 中执行以下命令进行安装
...
以上的代码或者命令中的 `4.0.6` 为 ML 的版本号，随着不断地更新迭代，您可以选择其他的版本，所有的版本可以在 [此处](https://www.nuget.org/packages/MinecraftLaunch#versions-body-tab) 查看
::
